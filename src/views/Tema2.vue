...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5(data-aos="fade-right")
      SlyderF(columnas="col-lg-6 col-xl-4")
        .tarjeta-avatar
          ...
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 1
            p.text-center.mb-0 Acceder a la información relacionada con la gestión del riesgo de desastres de todo el país.
        .tarjeta-avatar
        ...
        .tarjeta-avatar
          ...
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 3
            p.text-center.mb-0 Contribuir a la construcción, distribución y apropiación del conocimiento sobre el riesgo de desastres en el país.
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img08.svg' alt='AvatarTop')
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 4
            p.text-center.mb-0 Contribuir a la generación de los elementos de información e interacción para el seguimiento de las amenazas, vulnerabilidades y riesgos del país.
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img09.svg' alt='AvatarTop')
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 5
            p.text-center.mb-0 Contribuir a la divulgación de información relacionada con el conocimiento del riesgo, la prevención, la preparación, la respuesta y la recuperación.
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img10.svg' alt='AvatarTop')
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 6
            p.text-center.mb-0 Responder a las necesidades de información sobre las estadísticas de afectación y de apoyos brindados por el SNGRD en las situaciones de emergencia.
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img11.svg' alt='AvatarTop')
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 7
            p.text-center.mb-0 Articular los sistemas de información de las entidades nacionales, departamentales, distritales y municipales.
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img12.svg' alt='AvatarTop')
          .BGR01B.p-4
            .h4.text-center.mt-5 Acción 8
    ...
    .row.justify-content-center.mb-5
      .col-lg-8(data-aos="zoom-in")
        ...
        ImagenInfografica.color-secundario.mb-4
          ...
          .tarjeta.color-secundario.p-3(x="46.25%" y="45%" numero="1")
            ul.lista-ul--color.ms-4
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Se conocen los peligros y las vulnerabilidades?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Qué pautas y tendencias presentan los factores?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
          ...
          .tarjeta.color-secundario.p-3(x="46.25%" y="55%" numero="4")
            ul.lista-ul--color.ms-4
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Se realiza el seguimiento de los parámetros correctos?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Existe una base científica sólida para efectuar pronósticos?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
          ...
          .tarjeta.color-secundario.p-3(x="54.25%" y="45%" numero="2")
            ul.lista-ul--color.ms-4
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Reciben las alertas todas las personas en peligro?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Se comprenden los riesgos y las alertas?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
          ...
          .tarjeta.color-secundario.p-3(x="54.25%" y="55%" numero="3")
            ul.lista-ul--color.ms-4
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Se comprueban y ponen al día los planes de respuesta?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
                | ¿Se hace uso de las capacidades y de los conocimientos locales?
              li
                <i class="fas fa-circle" style="color:#fff; font-size: x-small"></i>
    ...
    p Los elementos principales de los Sistemas de Alerta Temprana son:

    .row.justify-content-center.mb-5
      .col-lg-3.col-md-6.col-10.col-lg-0.mb-4(data-aos="fade-right")
        .tarjeta--boton.color-acento-contenido.p-4
          .row.justify-content-center.mb-3
            .col-7
              img(src='@/assets/curso/tema2/img22.svg')
          h4.text-center Conocimiento y mapeo de amenazas.
      .col-lg-3.col-md-6.col-10.col-lg-0.mb-4(data-aos="flip-up")
        .tarjeta--boton.color-acento-contenido.p-4
          .row.justify-content-center.mb-3
            .col-7
              img(src='@/assets/curso/tema2/img23.svg')
          h4.text-center Monitoreo y pronóstico de eventos inminentes.
      .col-lg-3.col-md-6.col-10.col-lg-0.mb-4(data-aos="flip-up")
        .tarjeta--boton.color-acento-contenido.p-4
          .row.justify-content-center.mb-3
            .col-7
              img(src='@/assets/curso/tema2/img24.svg')
          h4.text-center Difusión de alertas a las autoridades políticas.
      .col-lg-3.col-md-6.col-10.col-lg-0.mb-4(data-aos="fade-left")
        .tarjeta--boton.color-acento-contenido.p-4
          .row.justify-content-center.mb-3
            .col-7
    ...
    .row.justify-content-center.mb-4(data-aos="fade-right")
      TabsC.color-primario
        .row.justify-content-around.align-items-center.py-3.py-md-4(titulo="Daños directos")
